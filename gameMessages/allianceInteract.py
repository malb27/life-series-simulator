MAJPOS = [
    ...
    "{g} give{s} important information on the other alliances to {ally}.",
    "{g} give{s} a large gift of resources to {ally}.",
]

MAJNEG = [
    "{g} set{s} fire to {ally}'{s2} base.",
    "{g} dump{s} lava on {ally}'{s2} base.",
    "{g} blow{s} up {ally}'{s2} base.",
    "{g} steal{s} a large amount of valuables from {ally}.",
]
